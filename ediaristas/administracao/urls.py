...
from .views import service_views, usuario_views
from django.contrib.auth import views as auth_views

urlpatterns = [
    path('servicos/cadastrar', service_views.cadastrar_servico, name='cadastrar_servico'),
    path('servicos/listar', service_views.listar_servicos, name='listar_servicos'),
    path('servicos/editar/<int:id>', service_views.editar_servico, name='editar_servico'),
